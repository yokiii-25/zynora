...
REPORT_PATH = (
    PROJECT_ROOT
    / "outputs"
    / "extra_trees_report.txt"
)

MODEL_PATH = (
    MODEL_DIRECTORY
    / "extra_trees_room_classifier.pkl"
)

LABEL_ENCODER_PATH = (
    MODEL_DIRECTORY
    / "extra_trees_label_encoder.pkl"
)

FEATURE_COLUMNS_PATH = (
    MODEL_DIRECTORY
    / "extra_trees_feature_columns.pkl"
)
...
def save_confusion_matrix(
    ...
    axis.set_title(
        "Extra Trees Room Classifier V2\n"
        "Confusion Matrix"
    )
    ...
    output_path = (
        CHART_DIRECTORY
        / "extra_trees_v2_confusion_matrix.png"
    )
...
def save_feature_importance_chart(
    ...
    output_path = (
        CHART_DIRECTORY
        / "extra_trees_v2_feature_importance.png"
    )

    importance_csv_path = (
        CHART_DIRECTORY
        / "extra_trees_v2_feature_importance.csv"
    )
