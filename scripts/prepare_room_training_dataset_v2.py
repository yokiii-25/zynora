...
REPORT_PATH = (
    PROJECT_ROOT
    / "outputs"
    / "room_training_dataset_v2_report.txt"
)
...
def generate_report(
    ...
    lines = [
        "=" * 100,
        "ZYNORA ROOM TRAINING DATASET V2 REPORT",
        "=" * 100,
        "",
        "DATASET SUMMARY",
        "-" * 100,
        ...
        f"Total V2 ML features        : {len(enhanced_features)}",
    ...
    lines.extend(
        [
            ...
            "-" * 100,
            "Aspect ratio, bounding-box features, rectangularity, convexity,",
            "door/window counts and neighbouring-room features are not included yet.",
            "Those features require additional geometry and graph information from the SVG parser.",
        ]
    )
...
def main() -> None:
    print("=" * 100)
    print("ZYNORA FEATURE ENGINEERING V2")
    print("=" * 100)
